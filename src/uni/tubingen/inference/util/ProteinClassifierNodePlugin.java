 ...
 * @author enrique
 */
public class ProteinClassifierNodePlugin extends Plugin {
    // The shared instance.
    private static ProteinClassifierNodePlugin plugin;

    /**
     * The constructor.
     */
    public ProteinClassifierNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ProteinClassifierNodePlugin getDefault() {
        return plugin;
    }
